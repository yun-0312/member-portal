...
<script setup>
    ...
    const thumbnails = ref({}) // 動画IDごとのサムネイルURL保持オブジェクト
    ...
    // プロバイダーの種類を取得 (youtube, vimeo, zoom, unknown)
    ...
    const getEmbedUrl = (url) => {
        ...
        // Zoom等のセキュリティ制約でiframe表示が不可な場合は null を返して別ボタンを表示
        return null
    }
